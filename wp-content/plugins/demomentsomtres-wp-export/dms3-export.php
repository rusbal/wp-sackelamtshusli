...
function dms3_export_fs() {
    global $dms3_export_fs;

    if (!isset($dms3_export_fs)) {
        // Include Freemius SDK.
        require_once dirname(__FILE__) . '/freemius/start.php';

        $dms3_export_fs = fs_dynamic_init(array(
            'id'             => '530',
            'slug'           => 'demomentsomtres-wp-export',
            'type'           => 'plugin',
            'public_key'     => 'pk_f3b6b89d0bf836a2e1f40509fa886',
            'is_premium'     => false,
            'has_addons'     => false,
...
class DeMomentSomTresExport {
    ...
    function export_wp() {
        ...
        //echo '<pre>post_ids'.print_r($post_ids,true);die; // debug purposes
        ?>
